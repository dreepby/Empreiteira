...
type
  ...
  public
    ...
    function ADDListaHash(var oLista: TObjectDictionary<string, TBairroDto>;
...
function TBairroModel.ADDListaHash(var oLista: TObjectDictionary<string,
  ...
  try
    ...
    begin
      ...
      begin
        ...
        oBairroDTO.oMunicipio.idMunicipio :=
          oQuery.FieldByName('bairro_idMunicipio').AsInteger;
...
function TBairroModel.ListarBairros(var DsBairro: TDataSource): Boolean;
begin
  ...
  Result := oQueryListaBairros.IsEmpty;
end;
